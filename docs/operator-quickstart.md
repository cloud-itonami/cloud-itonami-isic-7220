# Operator Quickstart — Research and experimental development on social sciences and humanities

Shortest path from clone to a verified local dry-run for **ISIC 7220** (`cloud-itonami-isic-7220`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7220.git
cd cloud-itonami-isic-7220
```
...
- Likely source path: `socialresearch.governor.cljc`
